...
스마트 컨트랙트의 검증은 올바른 컨트랙트를 실행하고 있는지 확인할 수 있는 중요한 과정입니다. 여러분은 온체인 상의 모든 스마트 컨트랙트에 대해 검증할 수 있습니다.
...
[CW2 Spec](../ko/04-smart-contracts/cw-plus/cw2/spec/)은 상태로 저장될 컨트랙트의 정보를 결정합니다. 컨트랙트의 정보는 아래의 커맨드를 통해 쿼리할 수 있습니다.
...
훌륭합니다. 위 쿼리를 통해 code\_id, creator address, admin 그리고 label 의 정보까지 알게 되었습니다.
...
[rust-optimizer](https://github.com/CosmWasm/rust-optimizer)은 효율적이고 사이즈가 작은 코드를 만드는 것에 더해, 비교할 수 있는 결정론적 코드 결과를 만들어 내기 위해서도 사용됩니다. 위의 예시에서 확인한 해시들은 모두 rust-optimizer의 결과값입니다.
